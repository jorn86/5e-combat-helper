// Copied from https://github.com/google/accompanist/tree/main/flowlayout/src/main/java/com/google/accompanist/flowlayout,
// which is apparently available for Android but not Desktop, but works just fine
...
private fun Flow(
    ...
    Layout(content, modifier) { measurables, outerConstraints ->
        ...
        fun canAddToCurrentSequence(placeable: Placeable) = currentSequence.isEmpty()
                || currentMainAxisSize + mainAxisSpacing.roundToPx() + placeable.mainAxisSize() <= constraints.mainAxisMax
